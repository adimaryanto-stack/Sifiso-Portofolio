            ...
            <div className="glass-card p-10 rounded-[2.5rem] space-y-10 border-primary/10">
              ...
              <div className="pt-10 border-t border-white/5">
                 {project.projectStatus === "live" && project.liveUrl ? (
                   ...
                   <Button disabled className="w-full h-16 py-4 text-sm uppercase tracking-[0.3em] font-black opacity-50 cursor-not-allowed border border-white/10 bg-white/5 text-muted-foreground w-full">
                      Offline Project
                   </Button>
                 )}
              </div>
